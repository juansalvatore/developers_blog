    ...
    return (
      <CreateProfileWrapper>
        <Form onSubmit={this.onSubmit}>
          ...
          <Subtitle>Lets get some information to make your profile stand out!</Subtitle>
          ...
          />
          <Space>
            <NativeSelect onChange={this.onSelect} style={{ display: 'flex' }} defaultValue="none">
          ...
          <Social pose={this.state.isOpen ? 'open' : 'closed'}>{this.displaySocialNetworkLinks()}</Social>
